...
- [x] ~~**Authoring source-of-record lives outside Git** (AODS `CR-009`)~~ — **CLOSED** 2026-07-30 Option B: binding SoR = this Git repo only; external `Website/docs/` not citeable until promoted. Residual: Option A import deferred; dangling Bible/IA links under `CR-023`.
