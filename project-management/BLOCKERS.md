...
- [ ] **Canon Lock is not on `main`** (AODS `CR-001`) — PR #125 unmerged while merged PRs #126/#127 already cite it; every governance citation is currently unverifiable. Owner: Architecture Board
