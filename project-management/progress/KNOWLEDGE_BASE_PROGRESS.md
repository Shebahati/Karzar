...
- [x] **KB-PT-00** — Canonical Product Type architecture contract (SPEC v0.1.0→**v0.1.1** + Proposed ADR-015 Hybrid + Master KB **v0.4.1**). Owner direction recorded; Board Accept not granted; no runtime. **KB-PT-01 governance-blocked** pending Board Hybrid clarification.
