...
- [x] **D16** Image-import priority (2026-07-30): closes AODS `CR-019` **Option A**. While **KB-001** remains deferred (**D7**/**D8**, revisit 2026-09-23), `docs/CATALOG_IMAGES_PLAN.md` is the authorized product-image import plan; the Knowledge Platform Phase-3 pause is **superseded-for-now** (losing side). Does **not** authorize production imports (ADR-012 / HC-09 still apply). Does **not** reopen CAT-002/KB-001 or change **D8**.
