...
- [x] **R9** OpenAPI contract drift undetected — Owner: Backend Architect — *mitigated 2026-07-30:* snapshot regenerated; `/api/v1/products/slug/{slug}` present; `--gate openapi` PASS. Residual: make the gate a required CI check (Phase 4 / AODS `CR-012` MITIGATED).
