...
- [ ] **R5** Single VPS staging=live blast radius — Owner: Ops / Mohammad Shebahati — *mitigate:* pre-release backup verification + named rollback owner (self, `CR-021` S1) + `RELEASE_PLAN.md` §4 + off-peak deployment; residual `CR-011`.
