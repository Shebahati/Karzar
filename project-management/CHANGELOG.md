...
## 2026-08-01
- [x] **Wave A caliper pilot 20 (live Category B)** — Owner-authorized; 20/20 INSIZE cat57 SKUs applied on `api.karzartools.com`; accuracy `0/01`→OEM `±…`; zero_price_writes; verify JSON + report. Next: range QA + display_type + expand.
