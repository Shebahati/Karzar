...
## 2026-08-01
- [x] **Frontend collaborator gates** — charter + Owner GitHub checklist + hardened CODEOWNERS + Collaborator Scope Gate CI + PR template FE block + handoff paste for `@mhrbzandi-Designer`. Agent cannot invite/protect via API (Owner clicks `OWNER_GITHUB_FRONTEND_ACCESS.md`).
