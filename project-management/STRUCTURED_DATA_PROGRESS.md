...
- [ ] **SEO-001** Ship Product/Offer/Breadcrumb JSON-LD on PDP+PLP — `in_progress` 90% | P0 | 16h | Sprint 01
  ...
  - [x] Tags: seo, schema
  - Acceptance Criteria:
    - [ ] Rich Results test passes for sample PDPs (pending staging URL)
...
## Evidence log
- [ ] PR link (SEO-001)
- [ ] Staging sample PDP (priced) Rich Results
- [ ] Staging sample PDP (inquiry / null price) — Product without Offer
- [ ] Staging category hub ItemList
