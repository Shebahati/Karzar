...
## Tasks
- [ ] **IMG-02A-02-BATCH-002** Sequential Existing Image Human Review Batch 002 — `in_progress` 90% | P1 | Sprint 05 — packaging + human review complete; 36 ShopMill watermarks; 17 REPLACE_REQUIRED; 1 MANUAL_REVIEW; schema batch identity corrected; decisions not applied; no DB/storage mutation
