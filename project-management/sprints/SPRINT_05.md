...
- [ ] **IMG-FAST-01** Catalog-wide one-image coverage sprint — `in_progress` 25% | P1 | Sprint 05 — 01A merged (#221); 01B R1 failed (green=0); R2 multi-adapter remediation
- [ ] **IMG-FAST-01B** Catalog-wide one-image discovery — `in_progress` 85% | P1 | Sprint 05 — Draft #223; R2 Artifact green=204/4708; R1 preserved; awaiting acceptance
