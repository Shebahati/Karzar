...
## Tasks
- [ ] **IMG-02B** Existing Source Paths — `in_progress` 40% | P1 | Sprint 05 — worklists complete; live discovery R1 recalibration (Dasqua/SAN OU calibration_failed; INSIZE partial 49→48 drift, 30/18 materialized); IMG-02B-05 not started; zero DB/ProductImage/app mutations
