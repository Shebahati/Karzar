...
## Tasks
- [ ] **IMG-02B** Existing Source Paths — `in_progress` 40% | P1 | Sprint 05 — worklists + R1 source-gap recalibration complete; overall discovery incomplete (Dasqua/SAN OU calibration_failed; INSIZE partial 30/18); IMG-02B-05 not started; zero DB/ProductImage/app mutations
