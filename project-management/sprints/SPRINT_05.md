...
## Tasks
- [ ] **IMG-02A-02** Existing Image Human Review Batches and Pilot 001 — `in_progress` 90% | P1 | Sprint 05 — pilot + human review complete (external evidence); 52 ShopMill watermarks; 41 REPLACE_REQUIRED; HTML offline URL contract; no DB/storage mutation; replacement not started
