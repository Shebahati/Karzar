...
## Tasks
- [ ] **IMG-02B** Existing Source Paths — `in_progress` 70% | P1 | Sprint 05 — worklists + parallel live discovery (Dasqua 2 / INSIZE 49 candidates, 18 unique downloads / SAN OU 0); consolidated external root ready; IMG-02B-05 human review next; zero DB/ProductImage/app mutations
