...
## todo
- [x] **KB-001** Knowledge platform phase-1 content graph seed — `done` 100% | P2 | 30h | Sprint 04 — Day-3 CLOSED (#176); Day-4/5 seeds + INSIZE classify map (Git); operator Alembic residual only
