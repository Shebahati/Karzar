...
## todo
- [x] **KB-001** Knowledge platform phase-1 content graph seed — `done` 100% | P2 | 30h | Sprint 04 — Day-3 CLOSED (#176); Day-4/5 seeds + classify map + admin read-only Knowledge UI; operator Alembic residual only
...
- [ ] **CAT-002** INSIZE JSON-schema content fill (staging apply) — `in_progress` 75% | P1 | 20h | Sprint 02
  ...
  - Acceptance Criteria:
    - [ ] ≥200 SKUs content QA
    - [x] price_fields_written=none (dry-run; apply HALTED)
  - Definition of Done:
    - [ ] SEO_PROGRESS note
...
- [x] **KB-REMEDIATION-00** Architecture contract — `done` 100% | P2 | Sprint 05 — SPEC v0.3.0→v0.4.1 Proposed
