...
class ErrorCode(str, Enum):
    ...
    PURCHASE_CHECKOUT_TEMPORARILY_DISABLED = "PURCHASE_CHECKOUT_TEMPORARILY_DISABLED"
    PAYMENT_GATEWAY_TIMEOUT = "PAYMENT_GATEWAY_TIMEOUT"
    PAYMENT_GATEWAY_ERROR = "PAYMENT_GATEWAY_ERROR"
    PAYMENT_VERIFY_FAILED = "PAYMENT_VERIFY_FAILED"
    SHIPPING_DATA_INCOMPLETE = "SHIPPING_DATA_INCOMPLETE"
    SHIPPING_DESTINATION_INVALID = "SHIPPING_DESTINATION_INVALID"
    SHIPPING_FREIGHT_REQUIRED = "SHIPPING_FREIGHT_REQUIRED"
    SHIPPING_UNAVAILABLE = "SHIPPING_UNAVAILABLE"
    SHIPPING_QUOTE_EXPIRED = "SHIPPING_QUOTE_EXPIRED"
    SHIPPING_QUOTE_MISMATCH = "SHIPPING_QUOTE_MISMATCH"
    SHIPPING_QUOTE_CONSUMED = "SHIPPING_QUOTE_CONSUMED"
    SHIPPING_QUOTE_REQUIRED = "SHIPPING_QUOTE_REQUIRED"
    SHIPPING_QUOTE_STALE = "SHIPPING_QUOTE_STALE"
    SHIPPING_BOOKING_DISABLED = "SHIPPING_BOOKING_DISABLED"
    SHIPMENT_NOT_FOUND = "SHIPMENT_NOT_FOUND"
    SHIPMENT_STATE_INVALID = "SHIPMENT_STATE_INVALID"
    SHIPPING_PROVIDER_CUTOFF = "SHIPPING_PROVIDER_CUTOFF"
    SHIPPING_METHOD_REQUIRED = "SHIPPING_METHOD_REQUIRED"
    SHIPPING_METHOD_INVALID = "SHIPPING_METHOD_INVALID"
    SHIPPING_METHOD_UNAVAILABLE = "SHIPPING_METHOD_UNAVAILABLE"
    SHIPPING_METHOD_DESTINATION_NOT_ELIGIBLE = "SHIPPING_METHOD_DESTINATION_NOT_ELIGIBLE"
