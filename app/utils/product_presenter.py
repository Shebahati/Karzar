...
def to_product_detail(
    ...
    *,
    ...
    return ProductDetailResponse(
        ...
        shipping_is_fragile=bool(getattr(product, "shipping_is_fragile", False)),
        shipping_is_liquid=bool(getattr(product, "shipping_is_liquid", False)),
        shipping_class=getattr(product, "shipping_class", None) or "parcel",
        is_original=product.is_original,
