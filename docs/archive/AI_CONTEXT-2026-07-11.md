# ARCHIVED — frontend/AI_CONTEXT.md full body (historical)

> **Do not use as SoT.** Quarantined 2026-07-30 under AODS CR-015 Option A.
> Live stub: `frontend/AI_CONTEXT.md` (banner + §21 only).
