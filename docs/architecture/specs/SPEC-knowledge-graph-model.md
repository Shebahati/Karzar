...
| KB-001 | Link articles↔products↔categories; avoid second taxonomy | archived `docs/archive/project-management/exports/tasks.json` KB-001; live status: GitHub Issues (`CR-024`) |
