...
After this document is on `main`, ensure it remains listed in `aods/registry/document-registry.yaml` (AODS registry gate requires classified active markdown). Branch membership is determined by git, not a registry boolean.
