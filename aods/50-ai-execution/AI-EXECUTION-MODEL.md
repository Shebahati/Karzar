...
| Context required | 1. `docs/architecture/rfc/RFC-005-brand-hub-launch.md` FULL · 2. `docs/architecture/adr/ADR-010-seo-url-contract.md` §3 · 3. `docs/ARCHITECTURE.md` §"Transaction ownership (BE-01)" · 4. `app/api/v1/endpoints/brands.py` FULL · 5. `app/services/brand_service.py` FULL · 6. `docs/API_CONTRACT.md` §Brands |
...
| Allowed paths | `app/api/v1/endpoints/brands.py`, `app/services/brand_service.py`, `app/schemas/brand.py` |
